:root {
    ...
    --color-accent-blue-dark: #047857;
    --color-accent-purple: #10b981;
    --color-accent-cyan: #14b8a6;
    --color-success: #10b981;
    --color-traffic-low: #34d399;
    --color-traffic-medium: #fbbf24;
    --color-traffic-warning: #fb923c;
    --color-traffic-heavy: #f87171;
    --color-alert-badge: #ef4444;
    --shadow-sm: 0 1px 2px 0 rgba(0, 0, 0, 0.05);
    --shadow-md: 0 4px 6px -1px rgba(0, 0, 0, 0.1),
    0 2px 4px -1px rgba(0, 0, 0, 0.06);
    --shadow-lg: 0 10px 15px -3px rgba(0, 0, 0, 0.1),
    0 4px 6px -2px rgba(0, 0, 0, 0.05);
    --shadow-glow-blue: 0 0 20px rgba(5, 150, 105, 0.4);
    --shadow-glow-purple: 0 0 30px rgba(16, 185, 129, 0.4);
    --radius-sm: 0.375rem;
    --radius-md: 0.75rem;
    --radius-lg: 1rem;
    --radius-xl: 1.5rem;
...
.theme-light .intersection-item {
    background-color: var(--color-bg-secondary);
    border: 1px solid var(--color-border);
}
.theme-light .intersection-item:hover {
    background-color: var(--color-bg-tertiary);
}
.theme-light .intersection-item.active {
    background: var(--color-bg-tertiary);
...
.theme-light .filter-controls select {
    background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23475569"><path d="M7 10l5 5 5-5z"/></svg>'); /* Thay đổi màu mũi tên dropdown */
    background-color: var(--color-bg-secondary);
...
.theme-light .custom-select:hover {
    background-color: var(--color-bg-tertiary);
...
.theme-light .account-settings-grid .form-group small {
...
.app {
    ...
    box-shadow: 0 20px 60px rgba(0, 0, 0, 0.5), var(--shadow-glow-blue);
    margin: 20px;
    position: relative;
    z-index: 1;
...
.login-container {
    min-height: 100vh;
    /* Dark background to match dashboard */
...
.login-card {
    ...
    padding: 48px 56px;
    border-radius: 20px;
    box-shadow: 0 25px 50px rgba(0, 0, 0, 0.5); /* Darker shadow */
    width: 100%;
    max-width: 440px;
...
.login-error {
    background: rgba(239, 68, 68, 0.1); /* Darker red bg */
...
.login-submit {
    width: 100%;
    padding: 15px;
    /* Blue button to match "Xem chi tiết" buttons */
    background: #2563eb;
    color: white;
    border: none;
    border-radius: 10px;
...
.account-settings-grid {
    display: grid;
    grid-template-columns: 1fr 1.2fr; /* Tỉ lệ 1:1.2, dành cho Avatar/Info và Password */
    gap: 30px;
}

/* Điều chỉnh lại style cho các form/card trong Account Settings */
.account-info-group {
    display: flex;
    flex-direction: column;
    gap: 30px;
...
/* Đảm bảo các input/button trong AccountSettings có style đồng nhất */
.account-settings-grid .segment-card {
    padding: 30px; /* Tăng padding tổng thể */
}

.account-settings-grid .login-submit {
    padding: 14px 20px;
    font-size: 16px;
    font-weight: 600;
}

.account-settings-grid .form-group small {
    font-size: 13px;
    color: var(--color-text-secondary);
}
...
.sidebar-user-avatar .icon-user-placeholder {
    width: 28px;
    height: 28px;
    color: var(--color-text-secondary);
}
...
.sidebar-user-card {
    ...
    /* --- Bố cục nằm ngang cho Avatar và Tên/Vai trò --- */
    display: flex;
    align-items: center; /* Căn giữa theo chiều dọc */
    gap: 10px; /* Khoảng cách giữa avatar và chi tiết */
}
...
.sidebar-user-card.active-dropdown {
    background-color: var(--color-bg-tertiary);
}
...
.user-dropdown-menu {
    position: absolute;
    bottom: calc(100% + 10px); /* Đặt phía trên card */
    left: 0;
    width: 280px;
    background-color: var(--color-bg-secondary);
    border: 1px solid var(--color-border);
    ...
    z-index: 50;
    padding: 10px 0;
    animation: fadeIn 0.2s ease-out, slideInUp 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);
...
.icon-logout-dropdown {
    -webkit-mask-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5-5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z"/></svg>');
    mask-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5-5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z"/></svg>');
}
...
.avatar-preview-large .icon-user-placeholder {
    width: 80px;
    height: 80px;
    color: var(--color-text-secondary);
}
...
.ch-grid::-webkit-scrollbar-track {
...
.ch-grid::-webkit-scrollbar-thumb:hover {
...
.intersection-status-dot-only {
    padding: 0 !important;
    background: none !important;
}
.intersection-status-dot-only .color-dot {
    width: 12px;
    height: 12px;
    animation: statusDotPulse 2s infinite ease-in-out; /* Thêm animation */
}
.intersection-item[data-status="low"] .intersection-status-dot-only .color-dot {
    background-color: var(--color-traffic-low);
}
.intersection-item[data-status="medium"]
.intersection-status-dot-only
.color-dot {
    background-color: var(--color-traffic-medium);
}
.intersection-item[data-status="heavy"]
.intersection-status-dot-only
.color-dot {
    background-color: var(--color-traffic-heavy);
}
...
.header-actions .action-btn.primary:active {
...
.alert-badge.pulse-animation {
    animation: alertPulse 2s infinite cubic-bezier(0.68, -0.55, 0.265, 1.55);
}
...
.alert-dropdown-menu {
    ...
    animation: fadeIn 0.2s ease-out, slideInDownAlert 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);
}
...
.alert-dropdown-menu .alert-item {
    transition: background-color 0.2s ease;
    cursor: pointer;
}

.alert-dropdown-menu .alert-item:hover {
    background-color: var(--color-bg-tertiary) !important;
}

.alert-dropdown-menu .alert-item.read {
    opacity: 0.7;
}

.alert-dropdown-menu .custom-select {
...
.alert-dropdown-menu .action-btn {
    padding: 6px 12px;
    font-size: 13px;
    background-color: var(--color-bg-tertiary);
}
.alert-dropdown-menu .action-btn:hover {
    background-color: var(--color-border);
}
...
.theme-light .header-actions .action-btn {
    background-color: var(--color-bg-secondary);
}
...
.low-traffic .color-dot {
    background-color: var(--color-traffic-low);
}
.medium-traffic .color-dot {
    background-color: var(--color-traffic-medium);
}
.heavy-traffic .color-dot {
    background-color: var(--color-traffic-heavy);
}
.no-connection .color-dot {
...
.segment-card:hover {
    ...
    box-shadow: var(--shadow-lg), 0 0 20px rgba(5, 150, 105, 0.15);
}
...
.trend-chart[data-trend="up"] p {
    color: var(--color-traffic-heavy);
}
.trend-chart[data-trend="down"] p {
    color: var(--color-traffic-low);
}
.trend-chart[data-trend="stable"] p {
    color: var(--color-accent-blue);
}
...
.intersection-status-badge.low {
    background: rgba(34, 197, 94, 0.15);
    color: #22c55e;
    border: 1px solid rgba(34, 197, 94, 0.3);
}

.intersection-status-badge.medium {
    background: rgba(251, 146, 60, 0.18);
    color: #fb923c;
    border: 1px solid rgba(251, 146, 60, 0.3);
}

.intersection-status-badge.heavy {
...
.intersection-status-badge.no-connection {
...
.intersection-item:hover .intersection-status-badge.heavy {
    transform: scale(1.05);
...
.progress-bar.low-gradient {
    background: linear-gradient(
            90deg,
            var(--color-traffic-low) 0%,
            var(--color-traffic-medium) 100%
    );
}
.progress-bar.medium-gradient {
    background: linear-gradient(
            90deg,
            var(--color-traffic-medium) 0%,
            var(--color-traffic-warning) 100%
    );
}
.progress-bar.heavy-gradient {
    background: linear-gradient(
            90deg,
            var(--color-traffic-warning) 0%,
            var(--color-traffic-heavy) 100%
    );
}
...
.icon-user-placeholder {
    -webkit-mask-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>');
    mask-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>');
}
...
.live-modal-content {
    ...
    border-radius: 12px;
    overflow: hidden;
    box-shadow: 0 15px 30px rgba(0, 0, 0, 0.5), var(--shadow-glow-blue);
